...
**Owner — profile ("Owner" tab)**
- ★ `Me.html` — the **Owner** tab (profile): name, email, phone, language, reminder-notifications toggle; **Log out** and **Delete profile** with confirm modals.
